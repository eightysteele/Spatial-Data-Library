...
class IntervalTest(unittest.TestCase):
    ...
    def test_query_intervals(self):
        ...
        self.assertEqual(intervals['i0'], [315,328])
        self.assertEqual(intervals['i1'], [316,326])
        self.assertEqual(intervals['i2'], [318,322])
        self.assertEqual(intervals.has_key('i3'), False)
